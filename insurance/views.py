...
def admin_view_policy_view(request):
    ...
    return render(
        request, "insurance/admin_view_policy.html", {"policies": policies}
    )
...
def admin_update_policy_view(request):
    policies = models.Policy.objects.all()
    return render(
        request, "insurance/admin_update_policy.html", {"policies": policies}
    )
...
def update_policy_view(request, pk):
    ...
    return render(
        request, "insurance/update_policy.html", {"policyForm": policyForm}
    )
...
def admin_delete_policy_view(request):
    policies = models.Policy.objects.all()
    return render(
        request, "insurance/admin_delete_policy.html", {"policies": policies}
    )
...
def admin_view_disapproved_policy_holder_view(request):
    policyrecords = models.PolicyRecord.objects.all().filter(
        status="Disapproved"
    )
    return render(
        request,
...
def admin_question_view(request):
    ...
    return render(
        request, "insurance/admin_question.html", {"questions": questions}
    )
